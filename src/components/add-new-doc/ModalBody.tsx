		...
		<div className='mt-6'>
			<p className='text-sm text-gray-500'>
				<div className='mb-3'>
					...
					<Input placeholder='Search' type="text" value={title} onChange={(e: ChangeEvent<HTMLInputElement>) => setTitle(e.target.value)} />
				</div>
            ...
            Close
					...
					<Button className='w-full' onClick={() => handleFileUpload(file)}>Submit</Button>
				</div>
