...
const ModalSelect = ({ setStatus }: Props) => {
	...
	return (
		<Listbox value={selectedStatus} onChange={(e) => onChange(e)}>
			<Listbox.Button className='bg-white border ring-1 ring-gray-200 w-full relative  text-start  text-sm rounded-lg focus:ring-gray-500 focus:border-gray-300 block  h-11 p-1  dark:bg-gray-100 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-300'> <span
